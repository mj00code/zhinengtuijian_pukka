...
public class EsDataService_demo {

	private static ESLogger logger = Loggers.getLogger(EsDataService_demo.class);
	private static EsDataService_demo recommendDataService;
	private static TransportClient client;
	private static Connection conn;
	private static SimpleDateFormat df;

	public static final EsDataService_demo getInstance(){
		try {
			if (recommendDataService == null) {
				synchronized (EsDataService_demo.class) {
					//-----------------es集群连接--------------------
					...
					recommendDataService = new EsDataService_demo();
	...
	public void delete(String indexName,String type) {
		try {
			org.elasticsearch.index.reindex.BulkByScrollResponse response = DeleteByQueryAction.INSTANCE.newRequestBuilder(client)
